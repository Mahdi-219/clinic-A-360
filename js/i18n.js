...
const TRANSLATIONS = {
    ar: {
        ...
        printNeedsSafariIOS: "الطباعة غير مدعومة من نظام آيفون داخل التطبيق المثبّت على الشاشة الرئيسية. افتح هذا الرابط من متصفح Safari مباشرة (مو من الأيقونة المثبّتة) وجرب الطباعة من هناك: {{url}}",
    ...
    en: {
        ...
        printNeedsSafariIOS: "Printing is not supported by iOS inside the app installed on your Home Screen. Open this link directly in Safari (not the installed icon) and print from there: {{url}}",
