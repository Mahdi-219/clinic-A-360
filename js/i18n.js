...
const TRANSLATIONS = {
    ar: {
        ...
        loginLocked: "محاولات دخول فاشلة كثيرة. الحساب مقفول مؤقتًا، حاول بعد {{minutes}} دقيقة.",
        ...
        pdfLibraryMissing: "تعذر تحميل مكتبة إنشاء PDF. تحقق من اتصال الإنترنت وأعد تحميل الصفحة.",
        pdfPreparing: "جاري تجهيز الملف...",
        pdfSaveSuccess: "تم حفظ ملف PDF بنجاح",
        pdfSaveFailed: "تعذر إنشاء ملف PDF، حاول مرة أخرى",
    ...
    en: {
        ...
        loginLocked: "Too many failed login attempts. The account is temporarily locked, try again in {{minutes}} minutes.",
        ...
        pdfLibraryMissing: "Could not load the PDF library. Check your internet connection and reload the page.",
        pdfPreparing: "Preparing file...",
        pdfSaveSuccess: "PDF file saved successfully",
        pdfSaveFailed: "Could not create the PDF file, try again",
